...
if __name__ == '__main__':
    ...
    parser.add_argument("--image", help='image path', default='test/106.jpg', type=str)
    ...
    bboxes = create_mtcnn_net(image, args.mini_lp, device, p_model_path='../weights/pnet.weights',
                              o_model_path='../weights/onet.weights')
