...
f1 = open(os.path.join('../../train/anno_store', 'pos_24_val.txt'), 'w')
f2 = open(os.path.join('../../train/anno_store', 'neg_24_val.txt'), 'w')
f3 = open(os.path.join('../../train/anno_store', 'part_24_val.txt'), 'w')
